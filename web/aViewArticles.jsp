...
<body>
     <%
            ...
            {
                out.println("<script>alert('Article Accepted Sccuessfully.')</script>");
            }
            if(request.getParameter("msg2")!=null)
            {
                out.println("<script>alert('Article Rejected Successfully ')</script>");
            }
        %>
        ...
        <table cellspacing="20px">
            ...
            <%
                    ...
                    try
                    {
                        ...
                        String str = "select articlename, category,department, image, description,status from articles where status='Pending'";
                        ...
                        while(rs.next()){
                            ...
                            <tr align="center">
                                ...
                                <td><%=rs.getString(1)%></td>
                                 ...
                                 <td colspan="2"><a href="acceptArticle.jsp?aname=<%=rs.getString(1)%>&dept=<%=rs.getString(3)%>"><button type="submit">Accept</button></a>
                                 <a href="rejectArticle.jsp?aname=<%=rs.getString(1)%>&dept=<%=rs.getString(3)%>"><button type="submit">Reject</button></a></td>
                            </tr>
                            <%
                        }
                    }catch(Exception e)
